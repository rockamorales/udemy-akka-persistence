...
object EventAdapters extends App {
  ...
  // event
  case class GuitarAdded(guitatId: String, guitarModel: String, guitarMake: String, quantity: Int)
  case class GuitarAddedV2(guitatId: String, guitarModel: String, guitarMake: String, quantity: Int, guitarType: String)
...
//        addGuitarInventory(guitar, quantity)
  ...
  // toJournal
  // extends EventAdapter that has both ReadEventAdapter and WriteEventAdapter
